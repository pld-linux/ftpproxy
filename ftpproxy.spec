...
ftp.proxy jest aplikacyjną bramką dla podzbioru protokołu FTP
opisanego w RFC 959. Pośredniczy w transferze pomiędzy klientem a
serwerem bez specjalnego patrzenia czy oba hosty są prawdziwymi
serwerami FTP.
